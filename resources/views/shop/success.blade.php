...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
   ...
   <div class="relative w-20 h-20 mb-6 mx-auto"> <svg class="w-full h-full transform -rotate-90">
        ...
        <div class="absolute inset-0 flex items-center justify-center z-10">
            <span id="countdown" class="text-2xl font-bold text-gray-700 leading-none pt-1">
                5
            </span>
        </div>
    </div>

    <p class="text-sm text-gray-500 mb-6">Je wordt automatisch teruggestuurd...</p>

    <a href="{{ route('shop.index') }}" class="bg-[#283142] text-white px-6 py-2 rounded hover:bg-[#284142] transition">
...
<script>
    // Instellingen
    let timeLeft = 5; // Seconden
    const totalTime = 5;
    
    // SVG Cirkel berekeningen
    ...
    // Functie om de cirkel te updaten
    ...
    const interval = setInterval(() => {
        ...
        // Bereken percentage voor de cirkel
